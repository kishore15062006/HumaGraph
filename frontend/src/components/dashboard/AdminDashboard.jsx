...
export default AdminDashboardimport React, { useEffect, useState } from "react";
...
const AdminDashboard = () => {
    ...
    const handleUpdateMetric = async (event) => {
        ...
        try {
            await api.put(
                `/admin/metrics/${editingMetric.id}`,
                {
                    name: formData.name,
                    unit: formData.unit,
            ...
            setError(
                err.response?.data?.error ||
                "Failed to update biometric metric."
            );
        }
    };
        ...
        <main className="admin-dashboard">
            ...
            <section className="admin-hero">
                <div>
                    ...
                    <p>
                        Manage users and biometric health standards
                        across the HumaGraph system.
                    </p>
                </div>
            </section>
                    ...
                    <section className="admin-section">
                        ...
                        <div className="section-heading">
                            <div>
                                ...
                                <p>
                                    Manage the health metrics used by
                                    the application.
                                </p>
                            </div>
                        </div>
