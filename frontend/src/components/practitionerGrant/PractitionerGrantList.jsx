...
const PractitionerGrantList = () => {
    ...
    const saveClinicalNote = async (id) => {
        try {
            await practitionerGrantService.updateNote(
                id,
                noteText
            );
    ...
    const handleViewData = async (grant) => {
        try {
            ...
            const response =
                await healthReadingService.getPatientReadings(
                    profileId
                );
            ...
            console.error(
                "Failed to fetch patient readings:",
                error
            );
    ...
    const handleRequestAgain = async (grant) => {
        try {
            ...
            await practitionerGrantService.requestAccess(
                patientEmail
            );
            ...
            console.error(
                "Failed to request access again:",
                error
            );
        ...
        <div className="page-container practitioner-grants-page">
            ...
            <div className="grant-summary-card">
                ...
                <div>
                    ...
                    <strong className="grant-summary-value">
                        {grants.length}
                    </strong>
                </div>
            ...
            <div className="grant-table-card">
                ...
                <div className="grant-table-header">
                    <div>
                        ...
                        <span>
                            Manage your secure healthcare connections
                        </span>
                    </div>
                </div>
